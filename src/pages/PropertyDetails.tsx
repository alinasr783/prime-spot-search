              ...
              <div className="bg-white rounded-2xl shadow-sm border border-border/50 p-8">
                ...
                <div className="space-y-6">
                  ...
                  <div className="rounded-xl overflow-hidden border border-border/20 shadow-sm">
                    <iframe
                      src={`https://www.google.com/maps/embed/v1/place?key=AIzaSyBFw0Qbyq9zTFTd-tUY6dOWTgHz1n_GQjs&q=${encodeURIComponent(property.location)}&zoom=15&maptype=roadmap&language=ar&region=EG`}
                      width="100%"
                      height="300"
                      style={{ border: 0 }}
